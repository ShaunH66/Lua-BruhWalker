...
MF_laneclear_mana = menu:add_slider("Minimum Mana To Harass", MF_laneclear, 1, 200, 50)
...
MF_jungleclear_mana = menu:add_slider("Minimum Mana To jungle", MF_jungleclear, 1, 200, 50)
